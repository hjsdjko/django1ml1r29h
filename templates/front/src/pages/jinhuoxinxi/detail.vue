...
<div>
	<div :style='{"padding":"20px","margin":"0px auto","borderColor":"#d3d3d3","borderRadius":"0px","background":"#fff","borderWidth":"0px","width":"1200px","borderStyle":"solid"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'＞'" :style='{"fontSize":"14px","lineHeight":"1","justifyContent":"flex-start","display":"flex"}'>
			...
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" to="/index/jinhuoxinxi"><a>{{item.name}}</a></el-breadcrumb-item>
		...
		<div class="attr" :style='{"padding":"0","margin":"0","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"calc(100% - 310px)","position":"relative","justifyContent":"space-between","order":"2"}'>
			...
			<div class="info" :style='{"padding":"0 0 10px","margin":"0","borderColor":"#eee","borderRadius":"0px","flexWrap":"wrap","background":"#fff","borderWidth":"0 0 1px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","order":"2"}'>
				...
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"49%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 5px 0 0","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"24px","fontWeight":"500","height":"24px"}'>菜品名称</div>
					<div  :style='{"padding":"0px 10px 0","whiteSpace":"nowrap","overflow":"hidden","color":"#999","flex":"1","width":"100%","fontSize":"14px","lineHeight":"24px","textOverflow":"ellipsis","height":"auto"}'>{{detail.caipinmingcheng}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"49%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 5px 0 0","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"24px","fontWeight":"500","height":"24px"}'>菜品分类</div>
					<div  :style='{"padding":"0px 10px 0","whiteSpace":"nowrap","overflow":"hidden","color":"#999","flex":"1","width":"100%","fontSize":"14px","lineHeight":"24px","textOverflow":"ellipsis","height":"auto"}'>{{detail.caipinfenlei}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"49%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 5px 0 0","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"24px","fontWeight":"500","height":"24px"}'>菜品特色</div>
					<div  :style='{"padding":"0px 10px 0","whiteSpace":"nowrap","overflow":"hidden","color":"#999","flex":"1","width":"100%","fontSize":"14px","lineHeight":"24px","textOverflow":"ellipsis","height":"auto"}'>{{detail.caipintese}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"49%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 5px 0 0","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"24px","fontWeight":"500","height":"24px"}'>进货日期</div>
					<div  :style='{"padding":"0px 10px 0","whiteSpace":"nowrap","overflow":"hidden","color":"#999","flex":"1","width":"100%","fontSize":"14px","lineHeight":"24px","textOverflow":"ellipsis","height":"auto"}'>{{detail.jinhuoriqi}}</div>
				</div>
				<div class="item" :style='{"padding":"0 0px","margin":"0 0 4px 0","borderColor":"#28890b10","background":"#fff","borderWidth":"0px","display":"flex","width":"49%","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 5px 0 0","color":"#333","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"24px","fontWeight":"500","height":"24px"}'>信息备注</div>
					<div  :style='{"padding":"0px 10px 0","whiteSpace":"nowrap","overflow":"hidden","color":"#999","flex":"1","width":"100%","fontSize":"14px","lineHeight":"24px","textOverflow":"ellipsis","height":"auto"}'>{{detail.xinxibeizhu}}</div>
				</div>
				<div class="btn" :style='{"width":"100%","padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0px solid #009cf530","cursor":"pointer","padding":"0 10px","margin":"0 10px 0 0","color":"#fff","borderRadius":"0px","background":"#b4a078","width":"auto","lineHeight":"34px","fontSize":"14px","height":"34px"}' v-if="btnAuth('jinhuoxinxi','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0px solid #f5340030","cursor":"pointer","padding":"0 10px","margin":"0 10px 0 0","color":"#fff","borderRadius":"0px","background":"#b4a078","width":"auto","lineHeight":"34px","fontSize":"14px","height":"34px"}' v-if="btnAuth('jinhuoxinxi','删除')" @click="delClick">删除</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      nextClick(page) {
		...
		// 修改
		editClick(){
			this.$router.push(`/index/jinhuoxinxiAdd?type=edit&&id=${this.detail.id}`);
		},
		// 删除
		async delClick(){
			await this.$confirm('是否删除此进货信息？')
			  .then(_ => {
			    this.$http.post('jinhuoxinxi/delete', [this.detail.id]).then(async res => {
					if (res.data.code == 0) {
						this.$message({
							type: 'success',
							message: '删除成功!',
