	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0px calc((100% - 1200px)/2)","borderColor":"#C20C0C","alignItems":"center","color":"rgb(204, 204, 204)","textAlign":"right","display":"flex","justifyContent":"flex-end","overflow":"hidden","top":"0","borderRadius":"0","left":"0","background":"#3a3a3a","borderWidth":"0px","width":"100%","fontSize":"14px","lineHeight":"36px","position":"fixed","borderStyle":"solid","height":"36px","zIndex":"1002"}'>
			...
			<div :style='{"padding":"0","margin":"0","left":"calc((100% - 1200px)/2)","background":"none","display":"inline-block","width":"calc((100% - 980px) / 2)","position":"absolute","float":"left","height":"100%"}'>
			  <span @click="goMenu('/index/home')" :style='{"padding":"0px","color":"inherit","alignItems":"center","display":"flex","width":"100%","lineHeight":"1.5","fontSize":"16px","float":"left","fontWeight":"500","height":"100%"}'>基于Django的个性化餐饮管理系统</span>
			</div>
...
export default {
    data() {
		...
		caipinxinxicaipinmingcheng: '',
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","首页总数"],"appFrontIcon":"cuIcon-form","buttons":["新增","查看","修改","删除","首页总数"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-link","buttons":["新增","查看","修改","删除"],"menu":"菜品分类","menuJump":"列表","tableName":"caipinfenlei"}],"menu":"菜品分类管理"},{"child":[{"allButtons":["新增","查看","修改","删除","菜品分类统计","菜品库存统计","查看评论","首页总数","首页统计","进货"],"appFrontIcon":"cuIcon-skin","buttons":["新增","查看","修改","删除","查看评论","首页总数","首页统计","进货"],"menu":"菜品信息","menuJump":"列表","tableName":"caipinxinxi"}],"menu":"菜品信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除","餐桌预订"],"appFrontIcon":"cuIcon-present","buttons":["新增","查看","修改","删除"],"menu":"餐桌信息","menuJump":"列表","tableName":"canzhuoxinxi"}],"menu":"餐桌信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除","审核"],"appFrontIcon":"cuIcon-pic","buttons":["查看","修改","删除","审核"],"menu":"餐桌预订","menuJump":"列表","tableName":"canzhuoyuding"}],"menu":"餐桌预订管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-vipcard","buttons":["查看","修改","删除"],"menu":"进货信息","menuJump":"列表","tableName":"jinhuoxinxi"}],"menu":"进货信息管理"},{"child":[{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-similar","buttons":["查看","修改"],"menu":"关于我们","tableName":"aboutus"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-addressbook","buttons":["查看","修改"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告资讯","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告资讯分类","tableName":"newstype"}],"menu":"系统管理"},{"child":[{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额"],"appFrontIcon":"cuIcon-time","buttons":["查看"],"menu":"未支付订单","tableName":"orders/未支付"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","发货","物流","核销"],"appFrontIcon":"cuIcon-medal","buttons":["查看","核销"],"menu":"已支付订单","tableName":"orders/已支付"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","物流","退货审核"],"appFrontIcon":"cuIcon-attentionfavor","buttons":["查看","退货审核","品销额","品销量"],"menu":"已完成订单","tableName":"orders/已完成"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额"],"appFrontIcon":"cuIcon-album","buttons":["查看"],"menu":"已取消订单","tableName":"orders/已取消"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","物流"],"appFrontIcon":"cuIcon-taxi","buttons":["查看"],"menu":"已退款订单","tableName":"orders/已退款"},{"allButtons":["新增","查看","修改","删除","导出","日销量","月销量","年销量","品销量","类销量","日销额","月销额","年销额","品销额","类销额","确认收货","物流"],"appFrontIcon":"cuIcon-circle","buttons":["查看"],"menu":"已发货订单","tableName":"orders/已发货"}],"menu":"订单管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","菜品分类统计","菜品库存统计","查看评论","首页总数","首页统计","进货"],"appFrontIcon":"cuIcon-form","buttons":["查看"],"menu":"菜品信息列表","menuJump":"列表","tableName":"caipinxinxi"}],"menu":"菜品信息模块"},{"child":[{"allButtons":["新增","查看","修改","删除","餐桌预订"],"appFrontIcon":"cuIcon-link","buttons":["查看","餐桌预订"],"menu":"餐桌信息列表","menuJump":"列表","tableName":"canzhuoxinxi"}],"menu":"餐桌信息模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","审核"],"appFrontIcon":"cuIcon-pic","buttons":["查看"],"menu":"餐桌预订","menuJump":"列表","tableName":"canzhuoyuding"}],"menu":"餐桌预订管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","菜品分类统计","菜品库存统计","查看评论","首页总数","首页统计","进货"],"appFrontIcon":"cuIcon-form","buttons":["查看"],"menu":"菜品信息列表","menuJump":"列表","tableName":"caipinxinxi"}],"menu":"菜品信息模块"},{"child":[{"allButtons":["新增","查看","修改","删除","餐桌预订"],"appFrontIcon":"cuIcon-link","buttons":["查看","餐桌预订"],"menu":"餐桌信息列表","menuJump":"列表","tableName":"canzhuoxinxi"}],"menu":"餐桌信息模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
