...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"0 0 0px","margin":"10px 0 0","borderColor":"#ddd","alignItems":"center","display":"flex","clear":"both","justifyContent":"","flexWrap":"wrap","background":"none","borderWidth":"0 0 0px","width":"100%","borderStyle":"solid","height":"auto","order":"1"}'>
      <el-form-item :style='{"margin":"0 5px 0 0"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 0 0 0px","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>餐桌编号：</div>
        <el-input v-model="formSearch.canzhuobianhao" placeholder="餐桌编号" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="btnAuth('canzhuoxinxi','新增')" :style='{"cursor":"pointer","border":"1px solid #ccc","padding":"0px 8px","margin":"0px 10px 0 0","color":"#666","borderRadius":"0px","background":"none","display":"inline-block","width":"auto","fontSize":"14px","lineHeight":"36px","height":"36px"}' type="primary" @click="add('/index/canzhuoxinxiAdd')"><i v-if="true" :style='{"color":"#666","margin":"0 2px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"width":"calc(100% - 0px)","padding":"20px 0 0 0","margin":"0","background":"none","flex":"1","order":"6"}'>
		...
		<div class="list1 index-pv1" :style='{"padding":"0 0 0 5px","margin":"10px 0 0","overflow":"hidden","color":"#666","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","height":"auto"}'>
			<div :style='{"border":"0px solid #ddd","cursor":"pointer","padding":"0","margin":"0 30px 30px 0","overflow":"hidden","flexWrap":"wrap","background":"#fff","display":"flex","width":"calc(25% - 30px)","position":"relative","justifyContent":"center","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				...
				<div :style='{"padding":"0 0px","borderColor":"#ddd","margin":"0px","whiteSpace":"nowrap","color":"#5A5A5A","textAlign":"center","overflow":"hidden","borderWidth":"0 0 0px","width":"100%","lineHeight":"30px","fontSize":"16px","textOverflow":"ellipsis","borderStyle":"solid"}' class="name ">餐桌状态:{{item.canzhuozhuangtai}}</div>
...
<script>
  export default {
    ...
    created() {
		...
		this.selectOptionsList.push({name:'餐桌类型',list:this.canzhuoleixingOptions,tableName: 'canzhuoleixing',check: -1})
	    this.canzhuozhuangtaiOptions = '已预约,未预约'.split(',');
		this.selectOptionsList.push({name:'餐桌状态',list:this.canzhuozhuangtaiOptions,tableName: 'canzhuozhuangtai',check: -1})
      this.getFenlei();
      this.getList(1, '全部');
    },
    //方法集合
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.canzhuobianhao != '') searchWhere.canzhuobianhao = '%' + this.formSearch.canzhuobianhao + '%';
        ...
        this.$http.get(`canzhuoxinxi/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        ...
        this.$router.push({path: '/index/canzhuoxinxiDetail', query: params});
      },
