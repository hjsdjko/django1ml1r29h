    ...
    >
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="餐桌编号" prop="canzhuobianhao">
            <el-input v-model="ruleForm.canzhuobianhao" 
                placeholder="餐桌编号" clearable :disabled=" false  ||ro.canzhuobianhao"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}'  label="餐桌类型" prop="canzhuoleixing">
            <el-select v-model="ruleForm.canzhuoleixing" placeholder="请选择餐桌类型" :disabled=" false  ||ro.canzhuoleixing" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}'  label="餐桌状态" prop="canzhuozhuangtai">
            <el-select v-model="ruleForm.canzhuozhuangtai" placeholder="请选择餐桌状态" :disabled=" false  ||ro.canzhuozhuangtai" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="更新时间" prop="gengxinshijian">
              <el-date-picker
          ...
          <el-form-item :style='{"width":"100%","padding":"0px","margin":"0 0 20px","background":"none","display":"inline-block"}' label="预订介绍" prop="yudingjieshao">
            <editor 
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`canzhuoxinxi/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('canzhuoxinxi/list', {
							...
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`canzhuoxinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
