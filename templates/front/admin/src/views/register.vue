	...
	<div>
		<div class="container" :style='{"minHeight":"100vh","border":"30px solid #ffc054","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231107/de423fd8df8f4765b7a00108faf7266e.jpg)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center bottom","backgroundRepeat":"no-repeat","justifyContent":"flex-end"}'>
			<el-form v-if="pageFlag=='register'" :style='{"border":"0px solid #f6f6f6","minHeight":"calc(100vh - 60px)","padding":"20px 60px 20px 120px","margin":"0","borderRadius":"0px","textAlign":"center","background":"#fff","width":"38vw","height":"auto"}' ref="rgsForm" class="rgs-form" :model="rgsForm" :rules="rules">
				<div v-if="true" :style='{"padding":"0px","margin":"0px auto 20px","borderColor":"#ffbb43","color":"#ffbb43","textAlign":"center","display":"inline-block","background":"#fff","borderWidth":"0 0 2px","width":"100%","lineHeight":"40px","fontSize":"20px","borderStyle":"solid","fontWeight":"500"}' class="title">基于Django的个性化餐饮管理系统注册</div>
