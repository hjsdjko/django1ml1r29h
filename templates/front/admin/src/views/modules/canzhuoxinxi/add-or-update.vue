	...
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="餐桌类型" prop="canzhuoleixing">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="餐桌状态" prop="canzhuozhuangtai">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="餐桌状态" prop="canzhuozhuangtai">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="type!='info'"  label="预订介绍" prop="yudingjieshao">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.yudingjieshao" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.yudingjieshao" label="预订介绍" prop="yudingjieshao">
                    <span :style='{"border":"2px solid #c8c8c8","padding":"0 20px","color":"inherit","background":"none","display":"inline-block","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"350px","fontWeight":"500"}' v-html="ruleForm.yudingjieshao"></span>
                </el-form-item>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				canzhuobianhao: [
					{ required: true, message: '餐桌编号不能为空', trigger: 'blur' },
				],
				canzhuotupian: [
				],
				canzhuoleixing: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='yudingjieshao'){
							this.ruleForm.yudingjieshao = obj[o];
							this.ro.yudingjieshao = true;
							continue;
						}
						if(o=='gengxinshijian'){
				...
				this.ruleForm.canzhuozhuangtai = '未预约'; 			}
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.yudingjieshao = this.ruleForm.yudingjieshao.replace(reg,'../../../django1ml1r29h/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
