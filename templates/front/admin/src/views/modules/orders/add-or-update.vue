	...
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="折扣价格" prop="discountprice">
					<el-input-number v-model="ruleForm.discountprice" placeholder="折扣价格" :readonly="ro.discountprice"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="折扣价格" prop="discountprice">
					<el-input v-model="ruleForm.discountprice" placeholder="折扣价格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="折扣总价格" prop="discounttotal">
					<el-input-number v-model="ruleForm.discounttotal" placeholder="折扣总价格" :readonly="ro.discounttotal"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="折扣总价格" prop="discounttotal">
