				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('caipinxinxi','进货')" @click="jinhuoxinxiCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
...
import jinhuoxinxiCrossAddOrUpdate from "../jinhuoxinxi/add-or-update";
	export default {
		...
		methods: {
			...
			jinhuoxinxiCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
